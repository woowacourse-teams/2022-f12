...
public class CustomPageableArgumentResolverTest {
    ...
    void 페이징_실패_페이지_번호_숫자_형식_아님() throws Exception {
        ...
        // when
        mockMvc.perform(get("/api/v1/products?page=abc&size=10&sort=rating,desc"))
    ...
    void 페이징_실패_최대_페이징_크기_초과() throws Exception {
        ...
        // when
        mockMvc.perform(get("/api/v1/products?page=0&size=151&sort=rating,desc"))
                .andExpect(status().isBadRequest())
                .andDo(print());
    ...
    void 페이징_실패_페이징_크기_숫자_형식_아님() throws Exception {
        ...
        // when
        mockMvc.perform(get("/api/v1/products?page=0&size=abc&sort=rating,desc"))
                .andExpect(status().isBadRequest())
                .andDo(print());
